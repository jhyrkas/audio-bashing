...
#f, ((ax1, ax2), (ax3, ax4)) = plt.subplots(2, 2, figsize=(11,8), sharey='row')
...
os.system('python3 ../audio_whacker.py -nsines=20 -bw_percent_low=0.001 -bw_percent_high=0.35 --normalize --consonance audio_files/saw_root.wav audio_files/saw_third_equal.wav audio_files/saw_fifth_equal.wav audio_files/saw_seven_equal.wav')
os.system('rm vanilla.wav')
os.system('rm diff.wav')
os.system('mv whacked.wav audio_files/saw_equal_complex_whacked.wav')
